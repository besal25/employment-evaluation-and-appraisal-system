	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=evaluator/new_evaluator"><i class="fa fa-plus"></i> Add New Evaluator</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <a class="dropdown-item" href="./index.php?page=evaluator/edit_evaluator&id=<?php echo $row['id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
...
<script>
	...
	$('.view_evaluator').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Evaluator Details","evaluator/view_evaluator.php?id="+$(this).attr('data-id'))
	})
